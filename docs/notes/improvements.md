...
- [backlog-2026-08-08.md](backlog-2026-08-08.md) — что осталось после работ по CSS-единицам,
  скролл-контейнеру, раскатке по парку и интеграции CallTouch: layout-половина css-units,
  три ADR-кандидата, расхождения ядра с деплойментами, мониторинг CallTouch, резервный
  сбор заявок.
