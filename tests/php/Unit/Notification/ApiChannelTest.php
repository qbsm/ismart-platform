...
final class ApiChannelTest extends TestCase
{
    ...
    private function channel(MockHttpClient $http, array $config = []): ApiChannel
    {
        return new ApiChannel($http, new NullLogger(), $config + [
            'enable' => true,
    ...
    {
        $c = new ApiChannel(new MockHttpClient(), new NullLogger(), [
            'enable' => true,
            'url' => 'https://api.example/v1/lead',
            'site' => '',
        ]);
